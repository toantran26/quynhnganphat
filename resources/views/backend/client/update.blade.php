    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{route('post-edit-client',['id'=>$data['client']->id])}}" method="post" id="submitForm" enctype="multipart/form-data">
                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-12">
                                                            <div class="wrap-count field-news-title has-success">
                                                                ...
                                                                @enderror
                                                                <input type="text" id="name_vi" value="{{ old('name_vi',$data['client']->name_vi) }}"
                                                            ...
                                                            <div class="wrap-count field-news-title has-success mt-3">
                                                                ...
                                                                @enderror
                                                                <input type="text" id="name_en" value="{{ old('name_en',$data['client']->name_en) }}"
                                                            ...
                                                            <div class="wrap-count field-news-title has-success mt-3">
                                                                ...
                                                                @enderror
                                                                <input type="text" id="link" value="{{ old('link',$data['client']->link) }}"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="wrap-count field-news-description has-success">
                                                                ...
                                                                <div class="img__avatar text-center position-relative"  style="width: 250px;margin: auto">
                                                                    <img  id ="avatar-show" src="{{($data['client']->avatar)?asset($data['client']->avatar) :asset('backend/dist/img/default.jpg') }}" alt="" style="width: 100%">
