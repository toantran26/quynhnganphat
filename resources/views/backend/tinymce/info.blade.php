...
<body class="block">
    <div id="js_wrap_quote" class="hide">
        <blockquote class="expNoEdit"style="display: block; width: 165px;border: solid 1px #fff; text-align: justify;padding: 8px; margin: 0 8px 0 0; font-size: 13px; line-height: 18px;"></blockquote>
    </div>
    <div id="wrap_quote">
