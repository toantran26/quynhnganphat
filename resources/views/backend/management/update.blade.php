    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{route('post-edit-management',['id'=>$data['management']->id])}}" method="post" id="submitForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$data['management']->id}}">
                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-12">
                                                            <div class="wrap-count field-news-title has-success">
                                                                ...
                                                                @enderror
                                                                <input type="text" id="name" value="{{ old('name_vi',$data['management']->name_vi) }}"
                                                            ...
                                                            <div style="display: none"  class="wrap-count field-news-title has-success" id="en__news__name">
                                                                ...
                                                                <input type="text" value="{{ old('name_en',$data['management']->name_en) }}" class="change-slug count-length form-control" name="name_en" placeholder="tên tiếng anh">
                                                                <div class="help-block"></div>
                                                            </div>
                                                            
                                                            <div class="wrap-count field-news-title has-success mt-3">
                                                                <label class="control-label" for="f_name">Chức vụ <span
                                                                        style="color: red">*</span></label>
                                                                @error('position_vi')
                                                                    <span style="color: red; font-size: 14px">{{ $message }}
                                                                    </span>
                                                                @enderror
                                                                <input type="text" id="position" value="{{ old('position_vi',$data['management']->position_vi) }}"
                                                            ...
                                                            <div style="display: none"  class="wrap-count field-news-title has-success" id="en__news__title">
                                                                <small id="emailHelp" class="form-text text-muted">(Bằng Tiếng Anh)</small>
                                                                <input type="text" value="{{ old('position_en',$data['management']->position_en) }}" class="change-slug count-length form-control" name="position_en">
                                                                <div class="help-block"></div>
                                                            </div>
                                                            <div class="wrap-count field-news-title has-success mt-3">
                                                                ...
                                                                @enderror
                                                                <input type="number" id="order_no" value="{{ old('order_no',$data['management']->order_no) }}"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="wrap-count field-news-description has-success">
                                                                ...
                                                                <div class="img__avatar text-center position-relative"  style="width: 250px;margin: auto">
                                                                    <img  id ="avatar-show" src="{{$data['management']->avatar ?? asset('backend/dist/img/default.jpg') }}" alt="" style="width: 100%">
