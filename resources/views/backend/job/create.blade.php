...
<div class="content-wrapper mt-2">
  <form action="{{route('add-jobs')}}" method="post" id="submitForm" enctype="multipart/form-data">
    @csrf
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Thêm mới bài tuyển dụng</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <div style="display: none" class="wrap-count field-news-title has-success" id="en__news__title">
                  ...
                  <input type="text" value="{{ old('title_en') }}" class="change-slug count-length form-control"
                    name="title_en" maxlength="255" data-target="news-slug" data-name="news-title" data-length="70"
                    aria-invalid="false">
                  <div class="help-block"></div>
                </div>
              </div>
              <div class="form-group d-none">
                <div class="wrap-count field-news-title has-success">
                  ...
                  <p style="color: red; font-size: 14px">* {{$message}}</p>
                  @enderror
                  <input type="text" id="slug" value="{{ old('slug') }}" class="change-slug count-length form-control"
                    name="slug" maxlength="255" data-target="news-slug" data-name="news-title" data-length="70"
                    aria-invalid="false">
                  <div class="help-block"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="wrap-count field-news-description has-success">
                  ...
                  <textarea id="news-description" class="count-length form-control" name="position_vi" maxlength="255"
                    ...
                    aria-invalid="false"><?php echo old('position_vi') ?></textarea>
                  <div class="help-block"></div>
                </div>
                ...
                <div style="display: none" class="wrap-count field-news-title has-success" id="en__desc">
                  ...
                  <textarea id="news-description" class="count-length form-control" name="position_en" maxlength="255"
                    rows="1" data-name="news-description" data-length="165"
                    aria-invalid="false"><?= old('position_en') ?></textarea>
                  <div class="help-block"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="wrap-count field-news-description has-success">
                  ...
                  <p style="color: red; font-size: 14px">* {{$message}}</p>
                  @enderror
                  <?php $conten_s = '<div class="detail-recruit-content">
                    <blockquote class="expNoEdit quote">
                      <div class="expEdit quote-ct">
                      <h2 >Mô tả chi tiết công việc:</h2>
                      </div>
                      </blockquote>
                      <blockquote class="expNoEdit quote">
                      <div class="expEdit quote-ct">
                      <h2>Yêu cầu kinh nghiệm:</h2>
                      </div>
                      </blockquote>
                      <blockquote class="expNoEdit quote">
                      <div class="expEdit quote-ct">
                  ...
                  <textarea id="content" name="content_vi" class="content count-length form-control" rows="40">
                    
                    <?php echo(old('content_vi',$conten_s))?>
                  </textarea>
                  <div class="help-block"></div>
                </div>
                ...
                <div style="display: none" id="en__content" class=" wrap-count field-news-description has-success">
                  ...
                  <textarea id="content" name="content_en" class="count-length form-control content"
                    rows="40"><?php echo(old('content_en'))?></textarea>
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-6">
                  ...
                  <input type="text" id="offer" class="change-slug count-length form-control" name="offer"
                    value="{{ old('offer')}}" maxlength="255" data-target="news-slug" data-name="news-title"
                    data-length="70" aria-invalid="false">
            ...
            <div class="card-body">
                ...
                <div class="img__avatar text-center position-relative" style="width: 250px;margin: auto">
                  ...
                  <div class="input__file ">
                    <input class="position-absolute"
                      style="width: 100%;height: 100%;top: 0;left: 0;opacity: 0;cursor: pointer;" type="file"
              ...
              <div class="wrap-count field-news-description has-success mt-3">
                ...
                <div class="img__avatar text-center position-relative" style="width: 100px;margin: auto">
                  <img id="icon_avatar-show" src="{{asset('backend/dist/img/default.jpg')}}" alt=""
                    style="width: 100px">
                  <div class="input__file ">
                    <input class="position-absolute"
            ...
            <div class="card-body">
              ...
              <div class="form-group text-center">
                <button class="btn btn-success" name="status" value="{{config('constant.post_approved')}}"><i
                    class="fa fa-globe"></i> Đăng bài</button>
              </div>
            </div>
            <div class="help-block"></div>
          </div>
