            ...
            <div class="col-11">
                ...
                <div class="card-body card-secondary card-outline">
                    <div class="card-header " style="text-align: end">
                        <h3 class="card-title"><i class="fas fa-info-circle"></i> Chỉnh sửa trang tĩnh</h3>
                    </div>
                    <form action="{{route('update-page')}}"  method="post" id="submitForm" enctype="multipart/form-data">
                        @csrf
                        <input hidden name="id" value="{{ $onePage->id}}">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-11">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="wrap-count field-news-title has-success mb-2">
                                                ...
                                                @enderror
                                                <input type="text" id="title_vi" value="{{$onePage->title_vi}}" class="change-slug count-length form-control" name="title_vi" maxlength="255" data-target="news-slug" data-name="news-title" data-length="70" aria-invalid="false">
                                            ...
                                            <div style="display: none"  class="wrap-count field-news-title has-success" id="en__news__title">
                                                ...
                                                <input type="text" value="{{$onePage->title_en}}" class="change-slug count-length form-control" name="title_en" maxlength="255" data-target="news-slug" data-name="news-title" data-length="70" aria-invalid="false">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="wrap-count field-news-description has-success mb-2">
                                                ...
                                                <p style="color: red; font-size: 14px">* {{$message}}</p>
                                                @enderror
                                                <textarea id="news-description" class="count-length form-control" name="description_vi" maxlength="500" rows="3" data-name="news-description" data-length="165" aria-invalid="false"><?php echo $onePage->description_vi; ?></textarea>
                                                <div class="help-block"></div>
                                            </div>
                                            ...
                                            <div style="display: none"  class="wrap-count field-news-title has-success" id="en__desc">
                                                <small id="emailHelp" class="form-text text-muted">(Bằng Tiếng Anh)</small>
                                                <textarea id="news-description" class="count-length form-control" name="description_en" maxlength="500" rows="3" data-name="news-description" data-length="165" aria-invalid="false"><?php echo $onePage->description_en; ?></textarea>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="wrap-count field-news-description has-success mb-2">
                                                ...
                                                <p style="color: red; font-size: 14px">* {{$message}}</p>
                                                @enderror
                                                <textarea id="content" name="content_vi" class="content count-length form-control"  rows="40" ><?php echo $onePage->content_vi; ?></textarea>
                                                <div class="help-block"></div>
                                            </div>
                                            ...
                                            <div style="display: none" id="en__content" class=" wrap-count field-news-description has-success">
                                                <small id="emailHelp" class="form-text text-muted">(Bằng Tiếng Anh)</small>
                                                <textarea id="content" name="content_en" class="count-length form-control content"  rows="40" ><?php echo $onePage->content_en; ?></textarea>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="wrap-count field-news-description has-success">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="wrap-count field-news-description has-success">
                                                            ...
                                                            <input type="text" class="change-slug count-length form-control  " name="key_seo" value="{{$onePage->key_seo}}" >
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="wrap-count field-news-description has-success">
                                                            ...
                                                            <input type="text" class="change-slug count-length form-control" name="desc_seo" value="{{$onePage->desc_seo}}" >
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="wrap-count field-news-description has-success">
                                                            ...
                                                            <input type="text" class="change-slug count-length form-control  " name="title_seo" value="{{$onePage->title_seo}}" >
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" hidden>
                                            <div class="wrap-count field-news-title has-success">
                                                ...
                                                <p style="color: red; font-size: 14px">* {{$message}}</p>
                                                @enderror
                                                <input type="text" id="slug" value="{{ $onePage->slug}}" class="change-slug count-length form-control" name="slug" maxlength="255" data-target="news-slug" data-name="news-title" data-length="70" aria-invalid="false">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        <div class="form-group text-center">
                                            <button class="btn btn-success" name="status" value="{{config('constant.post_approved')}}"> Cập nhật</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
